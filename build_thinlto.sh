...
make KCFLAGS="-mcpu=cortex-a55" KBUILD_CFLAGS="-mcpu=cortex-a55" $MAKE_ARGS ${TARGET_DEVICE}_defconfig
...
make KCFLAGS="-mcpu=cortex-a55" KBUILD_CFLAGS="-mcpu=cortex-a55" $MAKE_ARGS -j$(nproc) Image.lz4 dtbs
