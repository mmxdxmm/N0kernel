...
make KCFLAGS="-mcpu=cortex-a77" KBUILD_CFLAGS="-mcpu=cortex-a77" $MAKE_ARGS ${TARGET_DEVICE}_defconfig
...
make KCFLAGS="-mcpu=cortex-a77" KBUILD_CFLAGS="-mcpu=cortex-a77" $MAKE_ARGS -j$(nproc) Image.lz4 dtbs
