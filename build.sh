...
set_C="ccache clang --target=aarch64-linux-gnu -Os -march=armv8.2-a+lse+crypto+dotprod -mcpu=cortex-a77 -flto -Wno-error -ffunction-sections -fdata-sections"
set_HOSTC="ccache clang --target=x86_64-linux-gnu -Os -flto -Wno-error -ffunction-sections -fdata-sections"
